#!/bin/sh
mavproxy.py --out=udpbcast:10.42.0.255:14550 --out=127.0.0.1:14550 --daemon --mav20 &
sleep 10 &&
~/.local/lib/python3.8/site-packages/mavsdk/bin/mavsdk_server udpin://127.0.0.1:14550 &
