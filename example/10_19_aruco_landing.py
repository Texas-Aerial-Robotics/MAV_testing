...
from field_traversal import move_east, move_north_south, connect_and_setup, start_offboard_mode
...
class DroneTracker:
    ...
    async def run(self):
        ...
        current_north = await move_north_south(drone, target_altitude, current_north, current_east, 30, "south")
